...
const ServicesCTA = () => {
  return (
    <section className="py-20 bg-gradient-to-r from-yellow-500 via-orange-500 to-yellow-600 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 lg:px-8 text-center">
        ...
        <p className="text-xl text-black/80 mb-12 leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
          <button className="group bg-black text-white px-12 py-6 text-xl font-bold hover:bg-gray-800 transition-all duration-300 transform hover:scale-105 shadow-2xl min-w-[280px] flex items-center justify-center">
            <Calendar className="w-6 h-6 mr-3 group-hover:scale-110 transition-transform" />
            Book a Free Consultation
          </button>
          
          <button className="border-3 border-black text-black px-12 py-6 text-xl font-bold hover:bg-black hover:text-white transition-all duration-300 transform hover:scale-105 min-w-[280px] flex items-center justify-center">
