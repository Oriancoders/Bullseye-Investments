...
const ServicesHero = () => {
  return (
    <section className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black relative overflow-hidden pt-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 sm:py-20 py-10">
        <div className="sm:text-center">
          {/* Badge */}
          <div data-aos="fade-up" className="inline-flex sm:items-center px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full border border-white/20 mb-8 sm:flex-row flex-col gap-2">
            <Target className="sm:w-4 sm:h-4 h-6 w-6 text-white mr-2" />
            <span className="text-white text-lg font-medium">What Bullseye Investments Offer</span>
          </div>

          {/* Main Headline */}
          <h1 data-aos="fade-up" className="text-5xl lg:text-7xl font-bold  text-white mb-6 leading-tight">
              Your Gateway to<br />
          ...
          {/* Subheading */}
          <p data-aos="fade-up" className="text-xl text-gray-300 mb-12 max-w-4xl mx-auto leading-relaxed">
          ...
          <a  href={ACCOUNTURL} target='_blank' className="bg-green-600 hover:bg-green-800  text-white px-6 py-3 font-semibold  transition-all duration-200 transform rounded-sm mb-12 max-w-[400px] w-full">
            <TrendingUp className="w-6 h-6 inline-block mr-3" />
            Start Your Investment Journey
          </a>

          {/* Supporting Text */}
          <p data-aos="fade-in" className="text-gray-400 text-sm mt-12">
