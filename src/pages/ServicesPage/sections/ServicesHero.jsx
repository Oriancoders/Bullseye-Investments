    ...
    <section className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black relative overflow-hidden pt-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 sm:py-20 py-10">
        <div className="sm:text-center">
          {/* Badge */}
          <div className="inline-flex sm:items-center px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full border border-white/20 mb-8 sm:flex-row flex-col gap-2">
          ...
          <button className="bg-green-600 hover:bg-green-800  text-white px-6 py-3 font-semibold  transition-all duration-200 transform rounded-sm mb-12 max-w-[400px] w-full">
