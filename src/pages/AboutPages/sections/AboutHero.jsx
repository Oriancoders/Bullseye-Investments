...
const AboutHero = () => {
  return (
    <section className=" bg-gradient-to-br from-black via-gray-900 to-black relative  sm:pt-20 pt-10">
      {/* Background Pattern */}
      <AOSInitializer/>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-fade-in">
            <div data-aos="fade-right" className="inline-flex items-center px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full border border-white/20 mb-8">
