        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-fade-in">
            ...
            <p className="text-xl text-gray-100 mb-8 leading-relaxed">
              We combine three decades of international expertise, regulatory compliance, 
              and innovative technology to deliver meaningful financial solutions for our clients worldwide.
            </p>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="text-center">
                  ...
                  <div className="text-gray-400 text-sm">Market Reach</div>
                </div>
              </div>
            </div>
          </div>
