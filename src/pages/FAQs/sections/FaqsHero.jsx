        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-fade-in">
            <div className="inline-flex items-center px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full border border-white/20 mb-8">
              ...
              <span className="text-white text-sm font-medium">FAQs & Support</span>
            </div>
            <h1 className="text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
              Frequently Asked  
              <span className="block text-gray-200">Questions & Policies</span>
            </h1>
            <p className="text-xl text-gray-100 mb-8 leading-relaxed">
              Find answers to common queries about our services, compliance procedures, 
              and policies. Learn about KYC, CDD, and how Bullseye Insurance Broker Pvt. Ltd. 
              ensures full adherence to SECP and AML/CFT regulations.
            </p>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl sm:p-8 p-4 border border-white/20 text-white ">
              <div className="grid sm:grid-cols-3 gap-6 mb-6">
                <div className="text-center space-y-2">
                  ...
                  <div className="text-xl font-bold text-white">KYC Policy</div>
                  <div className="text-gray-200 ">Customer Identification</div>
                </div>
                <div className="text-center space-y-2">
                  <ShieldCheck className="w-12 h-12 text-white mx-auto " />
                  <div className="text-xl font-bold text-white">CDD</div>
                  <div className="text-gray-200 ">Risk Profiling & Monitoring</div>
                </div>
                <div className="text-center space-y-2">
                  <HelpCircle className="w-12 h-12 text-white mx-auto " />
                  <div className="text-xl font-bold text-white">Investor Complaints</div>
                  <div className="text-gray-200 ">Contact Compliance Officer</div>
                </div>
              </div>

              <hr className='mb-6'/>
              <h1 className='text-xl font-bold text-center'>We’re Committed to Transparency & Compliance</h1>
            </div>
          </div>
        </div>
      </div>
